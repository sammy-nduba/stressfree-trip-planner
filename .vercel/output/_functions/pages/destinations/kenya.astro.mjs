...
const $$Kenya = createComponent(async ($$result, $$props, $$slots) => {
  const kenyaDestinations = await getDestinationsByCountry("Kenya");
  const kenyaPackages = await getPackagesByCountry("Kenya");
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Kenya Destinations - Stress-Free Holiday Makers" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="pt-24 pb-20 bg-gradient-to-b from-sky to-sand"> <!-- Hero Section --> <section class="px-6 py-16 bg-gradient-to-r from-ocean to-teal text-white"> <div class="max-w-6xl mx-auto text-center"> <h1 class="text-5xl md:text-6xl font-serif mb-4">
🇰🇪 Discover Kenya
</h1> <p class="text-xl md:text-2xl font-light max-w-3xl mx-auto">
From the legendary Masai Mara to pristine beaches, Kenya offers unforgettable safari experiences and diverse landscapes
...
Start planning your stress-free Kenyan adventure today. Our planner will help you organize every detail.
...
}, "/home/nduba/Desktop/projects/stressfree-trip-planner-master/src/pages/destinations/Kenya.astro", void 0);

const $$file = "/home/nduba/Desktop/projects/stressfree-trip-planner-master/src/pages/destinations/Kenya.astro";
const $$url = "/destinations/Kenya";
